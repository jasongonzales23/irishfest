...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Beverage.tokenvalue'
        db.add_column('inventory_beverage', 'tokenvalue',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Beverage.tokenvalue'
        db.delete_column('inventory_beverage', 'tokenvalue')
