...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BoothTokenNote.location'
        db.alter_column('inventory_boothtokennote', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.TokenBooth']))

    def backwards(self, orm):

        # Changing field 'BoothTokenNote.location'
        db.alter_column('inventory_boothtokennote', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Location']))
