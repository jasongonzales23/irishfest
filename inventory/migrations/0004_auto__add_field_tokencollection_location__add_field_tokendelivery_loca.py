...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TokenCollection.location'
        db.add_column('inventory_tokencollection', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['inventory.Location']),
                      keep_default=False)

        # Adding field 'TokenDelivery.location'
        db.add_column('inventory_tokendelivery', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['inventory.TokenBooth']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TokenCollection.location'
        db.delete_column('inventory_tokencollection', 'location_id')

        # Deleting field 'TokenDelivery.location'
        db.delete_column('inventory_tokendelivery', 'location_id')
