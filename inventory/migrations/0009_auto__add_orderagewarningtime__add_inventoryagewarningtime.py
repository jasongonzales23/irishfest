...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderAgeWarningTime'
        db.create_table('inventory_orderagewarningtime', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('time', self.gf('django.db.models.fields.IntegerField')(default=45)),
        ))
        db.send_create_signal('inventory', ['OrderAgeWarningTime'])

        # Adding model 'InventoryAgeWarningTime'
        db.create_table('inventory_inventoryagewarningtime', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('time', self.gf('django.db.models.fields.IntegerField')(default=45)),
        ))
        db.send_create_signal('inventory', ['InventoryAgeWarningTime'])


    def backwards(self, orm):
        # Deleting model 'OrderAgeWarningTime'
        db.delete_table('inventory_orderagewarningtime')

        # Deleting model 'InventoryAgeWarningTime'
        db.delete_table('inventory_inventoryagewarningtime')
