...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('inventory_order', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Order.timestamp'
        db.alter_column('inventory_order', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
