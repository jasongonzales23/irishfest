...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TokenDelivery.fiscal_day'
        db.add_column('inventory_tokendelivery', 'fiscal_day',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TokenDelivery.fiscal_day'
        db.delete_column('inventory_tokendelivery', 'fiscal_day')
