...
from inventory.models import Beverage, Location, Inventory, Note, Order, InventoryForm, OrderForm, StartingInventory, NoteForm
...
def startingInventory(request, location_number):
    ...
    inventory = StartingInventory.objects.filter(location=location).order_by('beverage')
